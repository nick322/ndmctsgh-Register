...
for id in RowId:
    browser.get(
        'https://www2.ndmctsgh.edu.tw/NewWebReg/Register/RegData?id=' + id)
    print('https://www2.ndmctsgh.edu.tw/NewWebReg/Register/RegData?id=' + id)
    ...
    img = Image.open(r'C:\chrome\filename.jpg')
